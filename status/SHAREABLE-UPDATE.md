# AhmadOS Shareable Update

## Current State
- The AhmadOS rebuild now has a structured `archiso` profile, real KDE/SDDM theming, and real QML-based Welcome and Update Center shells inside the live image.
