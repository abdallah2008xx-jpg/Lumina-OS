...
file_permissions=(
  ...
  ["/usr/local/bin/ahmados-apply-session-defaults"]="0:0:755"
  ["/usr/local/bin/lumina-apply-session-defaults"]="0:0:755"
  ...
  ["/usr/local/bin/ahmados-windows-apps"]="0:0:755"
  ["/usr/local/bin/ahmados-windows-apps-prep"]="0:0:755"
  ...
  ["/usr/local/bin/lumina-windows-apps"]="0:0:755"
  ["/usr/local/bin/lumina-windows-apps-prep"]="0:0:755"
