...
required_paths=(
    ...
    "${repo_root}/scripts/audit-release-evidence-target.ps1"
    "${repo_root}/scripts/new-release-evidence-runbook.ps1"
    "${repo_root}/scripts/new-release-evidence-action-pack.ps1"
    ...
    "${repo_root}/scripts/new-release-validation-action-pack.ps1"
    "${repo_root}/scripts/sync-release-validation-pass.ps1"
    "${repo_root}/scripts/new-release-validation-runbook.ps1"
    "${repo_root}/scripts/new-release-validation-workboard.ps1"
    "${repo_root}/scripts/sync-release-execution-status.ps1"
    "${repo_root}/scripts/sync-release-evidence-session-status.ps1"
    "${repo_root}/scripts/sync-release-evidence-pack.ps1"
    "${repo_root}/scripts/sync-release-evidence-pack-status.ps1"
    "${repo_root}/scripts/sync-release-control-center.ps1"
    ...
    "${repo_root}/status/evidence-packs/README.md"
