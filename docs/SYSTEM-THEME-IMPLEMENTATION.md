# Lumina-OS System Theme Implementation
...
- custom Lumina-OS color scheme under `archiso-profile/airootfs/usr/share/color-schemes/Lumina-OS.colors`
- custom Lumina-OS Plasma look-and-feel package under `archiso-profile/airootfs/usr/share/plasma/look-and-feel/com.ahmados.desktop/`
- branded wallpaper assets under `archiso-profile/airootfs/usr/share/ahmados/wallpapers/`
- live-session autostart hook that applies Lumina-OS defaults for the `live` user

## Plasma Application Path
The live session uses:
- `~/.config/kdeglobals` to point to the Lumina-OS color scheme and look-and-feel package
...
- the Plasma layout is implemented as a real look-and-feel package, but a full Lumina-OS Welcome app and Settings shell are still future work

## Next Logical Steps
- turn the SDDM theme into a fully packaged release asset with previews
- implement the Welcome flow as a real Qt/QML app
- replace more stock KDE entry surfaces with Lumina-OS-native pages over time
