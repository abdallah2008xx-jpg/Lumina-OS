...
- adapt the checklist to `stable` or `login-test` instead of reusing one generic runbook

## Recommended Flow
1. Run `scripts/new-cycle-handoff.ps1`
2. Reuse the generated `Run Label` exactly
3. Follow the mode-specific handoff from Windows prep to Arch build to VM cycle to release prep
