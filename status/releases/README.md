...
8. Review `status/evidence-packs/CURRENT-EVIDENCE-SESSION.md`
9. Review `status/evidence-packs/CURRENT-EVIDENCE-PACK.md`
10. Review `status/releases/CURRENT-RELEASE-EVIDENCE.md`
11. Review `status/releases/CURRENT-RELEASE-READINESS.md`
12. Review `status/releases/CURRENT-RELEASE-CONTROL-CENTER.md`
13. Review `status/release-candidates/CURRENT-RELEASE-CANDIDATE.md`
14. Review the generated `release-manifest.md`
15. Review the generated `release-notes.md`
16. Confirm the linked cycle-chain audit reflects the intended run
17. Run `scripts/validate-github-release-context.ps1`
18. Run `scripts/publish-github-release.ps1` with the prepared manifest
19. Confirm `status/release-candidates/CURRENT-RELEASE-CANDIDATE.md` now shows the published state
20. Verify the ISO and `SHA256SUMS.txt` assets in GitHub Releases
