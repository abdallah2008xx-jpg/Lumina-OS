...
$requiredPaths = @(
    ...
    "archiso-profile\airootfs\usr\local\bin\ahmados-windows-daily-surface",
    ...
    "archiso-profile\airootfs\usr\local\bin\ahmados-windows-collection-launch",
    "archiso-profile\airootfs\usr\local\bin\ahmados-windows-collection-menu-export",
    ...
    "archiso-profile\airootfs\usr\local\bin\ahmados-windows-daily-app-pack",
    "archiso-profile\airootfs\usr\local\bin\ahmados-windows-daily-app-picker",
    "archiso-profile\airootfs\usr\local\bin\ahmados-windows-daily-recent-sync",
    ...
    "archiso-profile\airootfs\usr\local\bin\lumina-windows-daily-surface",
    ...
    "archiso-profile\airootfs\usr\local\bin\lumina-windows-collection-launch",
    "archiso-profile\airootfs\usr\local\bin\lumina-windows-collection-menu-export",
    ...
    "archiso-profile\airootfs\usr\local\bin\lumina-windows-daily-app-pack",
    "archiso-profile\airootfs\usr\local\bin\lumina-windows-daily-app-picker",
    "archiso-profile\airootfs\usr\local\bin\lumina-windows-daily-recent-sync",
    ...
    "archiso-profile\airootfs\usr\share\applications\lumina-hardware-readiness-check.desktop",
    "archiso-profile\airootfs\usr\share\applications\lumina-install-finalize-report.desktop",
    ...
    "scripts\audit-release-evidence-target.ps1",
    "scripts\new-release-evidence-runbook.ps1",
    "scripts\new-release-evidence-action-pack.ps1",
    "scripts\start-release-evidence-session.ps1",
    "scripts\open-next-release-evidence.ps1",
    "scripts\open-next-release-action.ps1",
    "scripts\capture-release-evidence.ps1",
    "scripts\sync-release-evidence-session.ps1",
    "scripts\start-release-validation-pass.ps1",
    "scripts\new-release-validation-action-pack.ps1",
    "scripts\sync-release-validation-pass.ps1",
    "scripts\new-release-validation-runbook.ps1",
    "scripts\new-release-validation-workboard.ps1",
    "scripts\sync-release-execution-status.ps1",
    "scripts\sync-release-evidence-session-status.ps1",
    "scripts\sync-release-evidence-pack.ps1",
    "scripts\sync-release-evidence-pack-status.ps1",
    "scripts\sync-release-control-center.ps1",
    "scripts\new-test-session.ps1",
    ...
    "scripts\sync-release-evidence-audit-status.ps1",
    "scripts\audit-release-readiness.ps1",
    "scripts\sync-release-readiness-status.ps1",
    ...
    "status\login-tests\README.md",
    "status\install-tests\README.md",
    "status\hardware-tests\README.md",
    "status\evidence-packs\README.md",
...
if (Test-Path $customizeAirootfsPath) {
    ...
    foreach ($requiredChmodTarget in @(
        ...
        "/usr/local/bin/lumina-hardware-readiness-check"
    )) {
